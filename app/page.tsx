...
type Facility = {
  ...
  /** NEW: free text instead of typed BMS object */
  automationNotes?: string; // e.g., "BMS: Honeywell EBI 600; trending available" or "SCADA – Siemens"
    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="grid">
          ...
          {/* NEW: BMS / SCADA free text */}
          <div className="col2">
            <label>BMS / SCADA (brand & notes)</label>
            <input
              placeholder="e.g., 'BMS: Honeywell EBI; trending available' or 'SCADA – Siemens, limited points'"
              value={facility.automationNotes || ''}
              onChange={e => setFacility({ ...facility, automationNotes: e.target.value })}
            />
          </div>
        </div>
        ...
        <div className="grid">
          ...
          <div className="col2">
            ...
            <select
              ...
              onChange={e => {
                const opts = Array.from(e.target.selectedOptions).map(o => o.value) as NonNullable<Facility['lighting']>['controls'];
